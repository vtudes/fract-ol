...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/03/10 03:56:44 by vtudes            #+#    #+#             */
/*   Updated: 2018/03/10 03:56:45 by vtudes           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "fractol.h"

static void		calcb(t_mlx *st)
{
	st->c.tmp = st->c.z_r;
	st->c.z_r = (st->c.z_r / 1.61803398875) * st->c.z_r
	- st->c.z_i * st->c.z_i + st->c.c_r;
